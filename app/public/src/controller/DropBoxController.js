class DropBoxController {
  ...
  connectFirebase() {
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyDAerb7bMYFAQHIlVEoth7MbfUkxyxi0qA",
      authDomain: "dropbox-clone-bcb7f.firebaseapp.com",
      databaseURL: "https://dropbox-clone-bcb7f.firebaseio.com",
      projectId: "dropbox-clone-bcb7f",
      storageBucket: "dropbox-clone-bcb7f.appspot.com",
      messagingSenderId: "359183844604",
      appId: "1:359183844604:web:81853108526b075fa3c379",
      measurementId: "G-5Z3QV3VJL5",
    };
    // Initialize Firebase
  ...
  uploadProgress(event, file) {
    ...
    this.timeleftEl.innerHTML = this.formatTimeToHumam(timeleft);
  }

  formatTimeToHumam(duration) {
